...
import dataset.cifar100_vit_base.for_draw_train as item
...
checkpoint_path = "./dataset/cifar100_vit_base/checkpoint"
generated_path = "./dataset/cifar100_vit_base/generated"
tag = "cifar100_vit_base"
try:
    exec(sys.argv[1])
except:
...
pretrained_state = torch.load(
    "/home/wangkai/cvpr_pdiff/p-diff-v2/dataset/cifar100_vit_base/pretrained.pth")
