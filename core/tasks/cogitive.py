...
class CogTask(BaseTask):
    def __init__(self, config, **kwargs):
        ...
        # TODO: need to make custom cog dataset, change after the dataset is ready
    ...
    # TODO: need to check that the get_model and get_train_layer are properly implemented to work 
    ...
    # TODO: need to redo this whole implementation to benchmark RNN instead
    ...
    # TODO: we might get away with just not worrying about this or we can just adjust current code to implement this
    ...
    def train_for_data(self):
        ...
        tmp_path = os.path.join(data_path, 'tmp_{}'.format(
        ...
        for i in range(0, all_epoch):
            ...
            if i >= epoch:
                ...
                if len(parameters) == 10 or i == all_epoch - 1:
                    torch.save(parameters, os.path.join(
                        tmp_path, "p_data_{}.pt".format(i)))
                    parameters = []
