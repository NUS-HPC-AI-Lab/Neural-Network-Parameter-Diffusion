...
import dataset.ablation_cifar100_resnet18_different_ft_lr.for_draw_train as item
...
checkpoint_path = "./dataset/ablation_cifar100_resnet18_different_ft_lr/checkpoint_001"
generated_path = "./dataset/ablation_cifar100_resnet18_different_ft_lr/generated_001"
tag = "cifar100_resnet18_ablation_ft_lr_001"
try:
    exec(sys.argv[1])
except:
...
def compute_wrong_indices(diction):
    ...
    _, acc, all_targets, all_predicts = test(model=model, test_loader=loader, criterion=criterion, device=device)
...
pretrained_state = torch.load(
    "/home/wangkai/cvpr_pdiff/p-diff-v2/dataset/ablation_cifar100_resnet18_different_ft_lr/pretrained.pth")
