...
import dataset.cifar100_vit_tiny.for_draw_train as item
...
checkpoint_path = "./dataset/cifar100_vit_tiny/checkpoint"
generated_path = "./dataset/cifar100_vit_tiny/generated"
tag = "cifar100_vit_tiny"
try:
    exec(sys.argv[1])
except:
...
pretrained_state = torch.load(
    "/home/wangkai/cvpr_pdiff/p-diff-v2/dataset/cifar100_vit_tiny/pretrained.pth")
