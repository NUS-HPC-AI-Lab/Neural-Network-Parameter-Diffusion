...
import dataset.cifar10_resnet18.train as item
...
checkpoint_path = "./dataset/cifar10_resnet18/checkpoint"
generated_path = "./dataset/cifar10_resnet18/generated"
tag = "cifar10_resnet18bn"
try:
    exec(sys.argv[1])
except:
...
def compute_wrong_indices(diction):
    ...
    pretrained_state = torch.load(
        "/home/nus-wk/cvpr_pdiff/for_boya_2/AR-Param-Generation/dataset/cifar10_resnet18/pretrained.pth")
