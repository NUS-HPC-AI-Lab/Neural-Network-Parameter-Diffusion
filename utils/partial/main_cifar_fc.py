...
if __name__ == '__main__':
    ...
    for it in range(0, args.num_experts):
        ...
        for e in range(args.epochs):
            ...
            if e > 40:
                if acc > threshold:
                    parameters.append([p.detach().cpu() for p in well_net.parameters()][-2:]) #只存储fc的参数
