...
import dataset.cifar100_convnext_base.for_draw_train as item
...
checkpoint_path = "./dataset/cifar100_convnext_base/checkpoint"
generated_path = "./dataset/cifar100_convnext_base/generated"
tag = "cifar100_convnext_base"
try:
    exec(sys.argv[1])
except:
...
pretrained_state = torch.load(
    "/home/wangkai/cvpr_pdiff/p-diff-v2/dataset/cifar100_convnext_base/pretrained.pth")
