...
import dataset.in1k_vit_tiny.for_draw_train as item
...
checkpoint_path = "./dataset/in1k_vit_tiny/checkpoint"
generated_path = "./dataset/in1k_vit_tiny/generated"
tag = "in1k_vit_tiny"
try:
    exec(sys.argv[1])
except:
...
#                       strict=False)
model = timm.create_model('vit_tiny_patch16_224', pretrained=True, num_classes=1000)
model = model.to(device)
