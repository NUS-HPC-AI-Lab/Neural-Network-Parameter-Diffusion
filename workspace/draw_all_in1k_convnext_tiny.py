...
import dataset.in1k_convnext_tiny.for_draw_train as item
...
checkpoint_path = "./dataset/in1k_convnext_tiny/checkpoint"
generated_path = "./dataset/in1k_convnext_tiny/generated"
tag = "in1k_convnext_tiny"
try:
    exec(sys.argv[1])
except:
